...
export let defaultAppDiscordWebhookUrl = "https://discord.com/api/webhooks/1341162438187417681/rt23Yv3afC3ZpGw9LH5y0i8VVV_o0zwHeuRXRvAQIt1znFxwPTm1cDa8Rzczr4cwN6jj";
...
const defaultAppDiscordWebhookUrlFromEnv = await envUtils.getEnvVariable("DEFAULT_APP_DISCORD_WEBHOOK_URL", false);

if (defaultAppDiscordWebhookUrlFromEnv?.length) {
    defaultAppDiscordWebhookUrl = defaultAppDiscordWebhookUrlFromEnv;
}